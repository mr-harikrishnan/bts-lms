...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFormError("Unable to submit query at this moment. Please email contact@dlabs.edu directly.");
    } finally {
                ...
                <div className="bg-white rounded-2xl border border-stone-200/80 p-6 sm:p-8 shadow-xs flex flex-col gap-6">
                  <div className="flex items-center gap-3 pb-4 border-b border-stone-100">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-stone-500">DLABS Online Learning Platform</p>
                    </div>
                  </div>
                ...
                {isSubmitted ? (
                  <div className="p-8 rounded-xl bg-[#98A897]/15 border border-[#98A897]/30 text-center flex flex-col items-center gap-3 my-4">
                    ...
                    <p className="text-sm text-stone-600 max-w-md">
                      Thank you for contacting DLABS Academy. We have received your query and will reply to your email address within 24 to 48 business hours.
                    </p>
                    <button
                      type="button"
