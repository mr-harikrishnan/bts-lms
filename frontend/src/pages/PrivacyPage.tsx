        ...
        <section className="py-14 sm:py-18">
          <div className="max-w-[960px] mx-auto px-5 sm:px-8">
            <div className="bg-white rounded-2xl border border-stone-200/80 p-8 sm:p-12 shadow-xs flex flex-col gap-10 text-stone-700 leading-relaxed text-sm sm:text-base">
              ...
              <div>
                <p className="mb-4">
                  <strong>Brainstorm Creators</strong> (&quot;DLABS&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting the personal privacy and data security of learners, educators, and visitors who interact with our learning management platform at <strong>dlabs.edu</strong>.
                </p>
                <p>
              ...
              <div className="p-6 rounded-2xl bg-[#FAF9F6] border-2 border-[#98A897]/40">
                ...
                <p className="mb-3 text-stone-700">
                  <strong>Important Guarantee:</strong> DLABS and Brainstorm Creators <strong>DO NOT</strong> collect, store, view, or process sensitive credit card numbers, debit card details, CVV security codes, net banking credentials, or UPI PINs on our servers.
                </p>
              ...
              <div className="pt-6 border-t border-stone-100">
                ...
                <div className="p-5 rounded-xl bg-[#FAF9F6] border border-stone-200/80 text-sm">
                  ...
                  <p className="text-stone-600 mt-1">
                    Email:{" "}
                    <a href="mailto:privacy@dlabs.edu" className="text-[#697C70] underline">
                      privacy@dlabs.edu
                    </a>{" "}
                    /{" "}
