    ...
    <div className="bg-[#FAF9F6] font-sans text-[#2D3536] min-h-screen flex flex-col selection:bg-[#E2ECE5] selection:text-[#2D3536]">
      ...
      <main className="flex-grow">
          ...
          <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14">
            <div className="max-w-3xl">
              ...
              <p className="text-base sm:text-lg text-stone-600 font-normal leading-relaxed">
                DLABS is an educational initiative by <strong>Brainstorm Creators</strong>, created to equip college students and early-career professionals with practical, job-ready digital capabilities through structured, project-driven learning tracks.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
              <div className="lg:col-span-6 flex flex-col gap-6">
                ...
                <div className="p-8 rounded-2xl bg-white border border-stone-200/80 shadow-xs">
                  ...
                  <h2 className="text-xl font-bold text-[#2D3536] mb-3">The DLABS Philosophy</h2>
                  <p className="text-sm text-stone-600 leading-relaxed">
              ...
              <div className="lg:col-span-6 bg-white rounded-2xl border border-stone-200/80 p-8 shadow-xs flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4 text-sm text-stone-600">
                  <p className="leading-relaxed">
                    Operating out of Tamil Nadu, India, <strong>Brainstorm Creators</strong> manages the DLABS learning management system, course creation, curriculum reviews, student support operations, and corporate partnerships.
                  </p>
                  ...
                  <div className="pt-4 border-t border-stone-100 flex flex-col gap-2 text-xs text-stone-500">
                    ...
                    <div>
                      <strong className="text-stone-700">Official Contact:</strong> contact@dlabs.edu
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-14 sm:py-18">
          <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14 text-center">
