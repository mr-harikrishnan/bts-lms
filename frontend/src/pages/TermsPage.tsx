        ...
        <section className="py-14 sm:py-18">
          <div className="max-w-[960px] mx-auto px-5 sm:px-8">
            <div className="bg-white rounded-2xl border border-stone-200/80 p-8 sm:p-12 shadow-xs flex flex-col gap-10 text-stone-700 leading-relaxed text-sm sm:text-base">
              ...
              <div>
                <p className="mb-4">
                  Welcome to <strong>DLABS</strong> (&quot;the Platform&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;), an online educational learning management service owned and operated by <strong>Brainstorm Creators</strong>, having its registered operational office at 142/1, Avinashi Road, Peelamedu, Coimbatore, Tamil Nadu 641004, India.
                </p>
                <p>
                  By accessing, browsing, registering for an account, or purchasing any course on DLABS, you (&quot;User&quot;, &quot;Student&quot;, &quot;Learner&quot;, or &quot;you&quot;) agree to be bound by these Terms and Conditions, our{" "}
                  <Link to="/privacy" className="text-[#697C70] font-semibold underline hover:text-[#2D3536]">
                    Privacy Policy
                  </Link>
                  , and our{" "}
                  <Link to="/refund-policy" className="text-[#697C70] font-semibold underline hover:text-[#2D3536]">
              ...
              <div>
                ...
                <p>
                  ...
                  <a href="mailto:support@dlabs.edu" className="text-[#697C70] underline">
                    support@dlabs.edu
                  </a>{" "}
              ...
              <div>
                ...
                <p className="mb-3">
                  6.1. The educational content, project examples, and career guidance provided on DLABS are intended for skill development. We do not guarantee specific employment offers, salary figures, or promotional placements upon completion.
                </p>
                <p>
              ...
              <div>
                ...
                <p>
                  These Terms shall be governed by and construed in accordance with the laws of the Republic of India. Any legal dispute, controversy, or claim arising out of or relating to these terms or your use of DLABS shall be subject to the exclusive jurisdiction of the competent courts situated in <strong>Coimbatore, Tamil Nadu, India</strong>.
                </p>
              </div>
              ...
              <div className="pt-6 border-t border-stone-100">
                ...
                <div className="p-5 rounded-xl bg-[#FAF9F6] border border-stone-200/80 text-sm">
                  <p className="font-semibold text-[#2D3536]">Brainstorm Creators (DLABS Academy)</p>
                  ...
                  <p className="text-stone-600 mt-1">
                    ...
                    /{" "}
                    <a href="mailto:contact@dlabs.edu" className="text-[#697C70] underline">
                      contact@dlabs.edu
                    </a>
                  </p>
